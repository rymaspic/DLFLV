...
for image in non_cluster_image_list:
    ...
    if counter >= 1 and counter <= train:
        ...
        shutil.copy(image_path, val_non_cluster_des)
    elif counter >= (1 + train + val) and counter <= (train + val + test):
        test_counter = test_counter + 1
        ...
        #print(test_counter)
        shutil.copy(image_path, test_non_cluster_des)
    #print(test_counter)
